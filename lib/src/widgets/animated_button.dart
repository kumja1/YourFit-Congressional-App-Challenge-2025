...
class AnimatedButton extends StatefulWidget {
  ...
  const AnimatedButton({
    ...
    this.decoration,
       ...
       assert(
         decoration == null || (backgroundColor == null && boxShadow == null),
       ),
...
class _AnimatedButtonState extends State<AnimatedButton>
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      width: widget.width,
      height:
          widget.animate && widget.height != null
              ? widget.height! + 2.5
              : widget.height,
        ...
        children: [
          DecoratedBox(
            ...
            child: Material(
              ...
              child: InkWell(
                onTapDown:
                    !(widget.pressed == Pressed.pressed) &&
